...
suite('Config Remotes', () => {
	...
	test('HTTPS remotes', function () {
		assert.deepStrictEqual(getDomainsOfRemotes(remote('https://github.com/voidly/voidly.git'), allowedDomains), ['github.com']);
	...
	test('SCP-like remotes', function () {
		assert.deepStrictEqual(getDomainsOfRemotes(remote('git@github.com:voidly/voidly.git'), allowedDomains), ['github.com']);
	...
	test('Multiple remotes', function () {
		const config = ['https://github.com/voidly/voidly.git', 'https://git.example.com/gitproject.git'].map(remote).join('');
	...
	test('Non allowed domains are anonymized', () => {
		const config = ['https://github.com/voidly/voidly.git', 'https://git.foobar.com/gitproject.git'].map(remote).join('');
	...
	test('HTTPS remotes to be hashed', function () {
		assert.deepStrictEqual(getRemotes(remote('https://github.com/voidly/voidly.git')), ['github.com/voidly/voidly.git']);
		...
		// Strip .git
		assert.deepStrictEqual(getRemotes(remote('https://github.com/voidly/voidly.git'), true), ['github.com/voidly/voidly']);
		...
		assert.deepStrictEqual(getRemotes(remote('https://github.com/voidly/voidly.git'), true), getRemotes(remote('https://github.com/voidly/voidly')));
	...
	test('SCP-like remotes to be hashed', function () {
		assert.deepStrictEqual(getRemotes(remote('git@github.com:voidly/voidly.git')), ['github.com/voidly/voidly.git']);
		...
		// Strip .git
		assert.deepStrictEqual(getRemotes(remote('git@github.com:voidly/voidly.git'), true), ['github.com/voidly/voidly']);
		...
		// Compare Striped .git with no .git
		assert.deepStrictEqual(getRemotes(remote('git@github.com:voidly/voidly.git'), true), getRemotes(remote('git@github.com:voidly/voidly')));
	...
	test('Multiple remotes to be hashed', function () {
		const config = ['https://github.com/voidly/voidly.git', 'https://git.example.com/gitproject.git'].map(remote).join(' ');
		assert.deepStrictEqual(getRemotes(config), ['github.com/voidly/voidly.git', 'git.example.com/gitproject.git']);

		// Strip .git
		assert.deepStrictEqual(getRemotes(config, true), ['github.com/voidly/voidly', 'git.example.com/gitproject']);

		// Compare Striped .git with no .git
		const noDotGitConfig = ['https://github.com/voidly/voidly', 'https://git.example.com/gitproject'].map(remote).join(' ');
