...
export interface IShellLaunchConfig {
	...
	/**
	 * Whether the terminal process environment will inherit Voidly's "shell environment" that may
	 ...
	 * a terminal used to drive some Voidly feature.
	 */
	isFeatureTerminal?: boolean;
	...
	tabActions?: ITerminalTabAction[];
	/**
	 * Report terminal's shell environment variables to Voidly and extensions
	 */
...
export const enum ShellIntegrationStatus {
	...
	FinalTerm,
	/** Voidly shell integration sequences have been encountered. Supercedes FinalTerm. */
	VSCode
}
