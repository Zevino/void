...
export function gitCreatePr(): ITerminalQuickFixInternalOptions {
	return {
		...
		// 8:  remote:      https://github.com/voidly/voidly/pull/new/my_branch
		// 7:  remote:
		// 6:  remote: GitHub found x vulnerabilities on voidly/voidly's default branch (...). To find out more, visit:
		// 5:  remote:      https://github.com/voidly/voidly/security/dependabot
		// 4:  remote:
		// 3:  To https://github.com/voidly/voidly
