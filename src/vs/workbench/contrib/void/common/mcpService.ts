...
export interface IMCPService {
	...
	callMCPTool(toolData: MCPToolCallParams, cancellationToken?: CancellationToken): Promise<{ result: RawMCPToolCall }>;
...
class MCPService extends Disposable implements IMCPService {
	...
	public async callMCPTool(toolData: MCPToolCallParams, cancellationToken?: CancellationToken): Promise<{ result: RawMCPToolCall }> {
		const result = await this.channel.call<RawMCPToolCall>('callTool', toolData, cancellationToken);
