 ...
 * {@link IDetachedTerminalInstance} (a terminal used elsewhere in Voidly UI).
 */
 ...
 * to represent terminals that appear in other parts of the Voidly UI outside
...
export interface IXtermTerminal extends IDisposable {
	...
	*/
	...
	/**
	 * Selects the content between the two markers by their Voidly OSC `SetMarker`
