...
/**
 * Allows webviews to monitor when an element in the Voidly editor is being dragged/dropped.
 *
 * This is required since webview end up eating the drag event. Voidly needs to see this
